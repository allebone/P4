...
@section('content')
<!--<h1><span class="glyphicon glyphicon-remove-circle" aria-hidden="true" style="font-size: 30px;"></span> Incomplete Tasks</h1>
...
<script>
    $(document).ready(function() {
        ...
        function getData(page)
        {
            ...
            $.ajax({
                url: "{{ Route('incompleteTask') }}?page=" + page,
                cache: false,
                dataType: 'json',
                type: "get",
                beforeSend: function() {
                    ...
                    $("#links").html("");
                    $("#incomplete_task_table tbody").html('<tr><td colspan="6"><center><img src="{{ asset("assets/images/loader_large.gif") }}" /></center></td></tr>');
//                    $("#loader_image").html('<center><div class="loader_large img_load"><img src="{{ asset("assets/images/large_loader.gif") }}" /></div></center>');
                ...
                success: function(data) {
                    ...
                    $("#incomplete_task_table tbody").html(data.task);
        ...
        $(document).off("click", ".pagination li a").on("click", ".pagination li a", function(e) {
            ...
            var page = url.substring(url.lastIndexOf("/") + 21);
